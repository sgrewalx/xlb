...
const staticRoutes = [
  ...
  },
  {
    ...
    eyebrow: "Sports",
    h1: "Fast-moving sports coverage",
    intro: "Open a compact selection of sports stories and fixtures, with clear attribution and direct source links.",
    kind: "collection",
    ogType: "website",
  ...
  },
  {
    ...
    eyebrow: "News",
    h1: "Stories worth checking now",
    intro: "Open a compact selection of current headlines, with clear attribution and direct links to original reporting.",
    kind: "collection",
    ogType: "website",
    imagePath: "/og-image.svg",
    links: [
  ...
  },
  {
    ...
    eyebrow: "Technology",
    h1: "Latest technology news",
    intro: "Open a focused selection of technology stories covering products, platforms, and important industry changes.",
    kind: "collection",
    ogType: "website",
    imagePath: "/media/modules/satellites.svg",
    links: [
